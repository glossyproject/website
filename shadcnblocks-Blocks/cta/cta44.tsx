...
interface Cta44Props extends CtaImageBackgroundProps {
  eyebrow?: string;
  eyebrowIcon?: ReactNode;
}
type Props = Partial<Cta44Props>;

const defaultProps: Cta44Props = {
  ...
  return (
    <section className={cn(className)}>
      <div className="relative flex h-[400px] items-center justify-center overflow-hidden md:h-[600px]">
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col gap-8 p-4 text-center text-primary-foreground">
          <h2 className="mx-auto max-w-3xl text-2xl font-semibold tracking-tight text-balance md:text-5xl">
            {heading}
          </h2>
          <p className="text-base font-medium text-primary-foreground/90 md:text-lg">
            {description}
          </p>
