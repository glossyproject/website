...
interface Footer52Props extends FooterBasicProps {}
type Props = Partial<Footer52Props>;

const defaultProps: Footer52Props = {
  logo: {
...
/** Slightly darker than `bg-muted` for the full-bleed legal strip */
const copyrightBarBg =
  "bg-[color-mix(in_oklch,var(--muted)_90%,var(--foreground)_10%)]";

const Footer52 = (props: Props) => {
