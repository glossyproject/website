...
interface Pricing52Props extends Pricing3PlansProps {}
type Props = Partial<Pricing52Props>;
...
const defaultProps: Pricing52Props = {
...
const PlanCard = ({
  ...
  plan: Pricing3PlansProps["plans"][number];
              ...
              <CarouselContent className="-ml-4">
                {plans.map((plan, index) => {
                  ...
                  return (
                    <CarouselItem
                      key={plan.name}
                      className="basis-full pl-4 sm:basis-[80%] md:basis-[65%] lg:basis-[50%]"
                    >
                      <div
