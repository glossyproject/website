...
interface Pricing74Props extends PricingCards2CardsProps {}
type Props = Partial<Pricing74Props>;

const defaultProps: Pricing74Props = {
  heading: "Pricing",
...
const PlanCard = ({
  ...
  >
    {highlighted && (
      <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary px-4 py-1 text-xs font-medium text-primary-foreground">
        Popular
      </div>
    )}
