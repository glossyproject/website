...
interface Pricing50Props extends Pricing3PlansProps {}
type Props = Partial<Pricing50Props>;
...
const defaultProps: Pricing50Props = {
    ...
    <section className={cn("py-24 lg:py-32", className)}>
      <div className="container">
        <div className="mx-auto max-w-6xl space-y-10">
          ...
          <div className="grid items-stretch gap-6 lg:grid-cols-12 lg:gap-4">
            {plans.map((plan) => {
              ...
              return (
                <Card
                  ...
                  className={cn(
                    ...
                    isSpotlight &&
                      "border-primary shadow-md ring-1 shadow-primary/10 ring-primary/20 lg:z-10 lg:col-span-4 lg:-my-2 lg:scale-[1.02]",
                  )}
                >
