    ...
    sections: [
      {
        ...
        items: [
          ...
          { label: "Uploads", icon: Folder, href: "#" },
...
const data = {
  user: {
    ...
    avatar:
      "https://deifkwefumgah.cloudfront.net/shadcnblocks/block/avatar/avatar10.webp",
  },
  participants: [
    {
      id: "you",
        ...
        <div className="space-y-2">
          {data.activity.map((event) => {
            ...
            return (
              <div
                key={event.id}
                className="flex gap-3 rounded-md p-2 hover:bg-accent/50"
              >
                <div className="mt-0.5 flex size-8 shrink-0 items-center justify-center rounded-md bg-accent/50">
...
export function ApplicationShell7({ className }: ApplicationShell7Props) {
  ...
  return (
    ...
    >
      ...
      <SidebarInset>
        <header className="sticky top-0 flex h-14 shrink-0 items-center gap-2 border-b bg-background px-3">
