  ...
  return (
    <div className={cn("relative", className)}>
      ...
      <Input
        ...
        className="h-9 w-full rounded-full bg-muted pl-9"
        aria-label="Search tokens"
      />
      <span className="pointer-events-none absolute top-1/2 right-2.5 -translate-y-1/2 rounded-full bg-accent px-2 py-0.5 text-[10px] text-muted-foreground">
        /
      </span>
    </div>
  );
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          className="gap-2 rounded-full border border-border bg-background px-3"
        >
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-80 p-3">
          ...
          {notifications.map((item) => (
            ...
            >
              <span
                aria-hidden="true"
                className={cn(
                  "mt-1 flex size-7 items-center justify-center rounded-full bg-accent text-xs",
                  item.tone,
                )}
              />
        ...
        <button className="mt-3 w-full rounded-md border border-border py-1 text-xs text-muted-foreground">
...
function UserMenu() {
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="flex items-center gap-2 rounded-full border border-transparent px-2 py-1 text-sm hover:bg-accent/50">
          ...
          <div className="mx-auto w-full max-w-7xl px-4">
            <div className="flex items-center justify-between gap-4 py-3">
              <div className="flex items-center gap-2 md:gap-3">
                <MobileMenu />
                <div className="flex size-9 items-center justify-center rounded-full bg-primary/10 text-primary md:hidden">
                  <Wallet className="size-4" />
                </div>
