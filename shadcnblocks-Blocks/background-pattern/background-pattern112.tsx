...
interface BackgroundPattern112Props {
  className?: string;
}

const BackgroundPattern112 = ({ className }: BackgroundPattern112Props) => {
  return (
    <section
      className={cn(
    ...
    >
      {/* Background Pattern */}
      {/* radial gradient with right fade dot Pattern */}
      ...
      <div
        ...
        style={{
          ...
          maskImage:
            "radial-gradient(ellipse at 20% 14%, rgba(0, 0, 0, 1), transparent 40%)",
          WebkitMaskImage:
            "radial-gradient(ellipse at 20% 14%, rgba(0, 0, 0, 1), transparent 40%)",
        }}
      />
