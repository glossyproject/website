...
interface BackgroundPattern113Props {
  className?: string;
}

const BackgroundPattern113 = ({ className }: BackgroundPattern113Props) => {
  return (
    <section
      className={cn(
    ...
    >
      {/* Background Pattern */}
      {/* radial gradient with bottom right fade dot Pattern */}
      ...
      <div
        ...
        style={{
          ...
          maskImage:
            "radial-gradient(ellipse at 100% 100%, rgba(0, 0, 0, 1), transparent 40%)",
          WebkitMaskImage:
            "radial-gradient(ellipse at 100% 100%, rgba(0, 0, 0, 1), transparent 40%)",
        }}
      />
