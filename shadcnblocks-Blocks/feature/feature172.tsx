  ...
  return (
    ...
    >
      ...
      {item.fade.includes("bottom") && (
        <div className="bg-linear-to-t from-background/80 absolute inset-0 z-10 via-transparent to-transparent md:hidden" />
      )}
              ...
              {item.images.slice(0, 4).map((image, j) => (
                ...
                >
                  <img
                    src={image.src}
                    alt={image.alt}
                    className="object-top-left size-8 object-contain lg:size-12"
                  />
                  <div className="bg-linear-to-l from-background/80 absolute inset-y-0 right-0 z-10 w-16 to-transparent" />
                </div>
              ))}
            </div>
              ...
              {item.images.slice(4).map((image, j) => (
                ...
                >
                  <img
                    ...
                    className="object-top-left size-8 object-contain lg:size-12"
                  />
                  <div className="bg-linear-to-r from-background/80 absolute inset-y-0 bottom-0 left-0 z-10 w-14 to-transparent" />
                </div>
              ))}
            </div>
          </div>
