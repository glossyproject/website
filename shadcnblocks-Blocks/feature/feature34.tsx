    ...
    <section className="py-32">
      <div className="container">
        ...
        <div className="mx-auto grid gap-10 lg:grid-cols-3">
          <div className="bg-muted order-1 flex h-full items-center rounded-lg p-4 lg:order-none">
            <div className="bg-background mx-auto max-w-80 rounded-lg p-6">
          ...
          <div className="bg-muted order-3 flex h-full items-center rounded-lg lg:order-none">
            <img
          ...
          <div className="bg-muted order-5 grid h-full grid-cols-3 gap-4 rounded-lg p-4 lg:order-none">
            <div className="bg-background flex items-center justify-center self-stretch rounded-lg text-4xl font-medium">
              01
            </div>
            <div className="bg-background col-span-2 flex items-center justify-center self-stretch rounded-lg p-6 text-4xl font-medium">
              <img
            ...
            <div className="bg-background col-span-3 flex items-center justify-center self-stretch rounded-lg p-6 text-4xl font-medium">
              <img
          ...
          <div className="order-2 -mt-6 max-w-[412px] lg:order-none">
            <p className="text-muted-foreground mb-6 text-sm lg:mb-12">
