...
interface Feature369Props extends FeatureIconListProps {}
type Props = Partial<Feature369Props>;

const defaultProps: Feature369Props = {
  features: [
    {
