...
interface Feature363Props extends FeatureIconListProps {}
type Props = Partial<Feature363Props>;

const defaultProps: Feature363Props = {
      ...
      <div className="container">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {items.map((feature, i) => (
            <div
              key={i}
              className="flex flex-col gap-4 rounded-lg border p-6 md:p-8"
            >
