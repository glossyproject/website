...
interface Feature368Props extends FeatureIconListProps {}
type Props = Partial<Feature368Props>;

const defaultProps: Feature368Props = {
  features: [
    {
