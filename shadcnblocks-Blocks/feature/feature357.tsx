...
interface Feature357Props extends FeatureIconListProps {}
type Props = Partial<Feature357Props>;

const defaultProps: Feature357Props = {
  ...
  return (
    <section className={cn("py-32", className)}>
      <div className="container">
        <div className="mx-auto mb-20 flex max-w-3xl flex-col items-center gap-4 text-center">
