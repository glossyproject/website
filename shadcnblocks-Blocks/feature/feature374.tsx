...
/** Editorial split: eyebrow, stacked headline, numbered rail; **aspect-3/4** image `rounded-lg` without shadow. */
const Feature374 = (props: Props) => {
  const {
    label,
    heading,
    headingAccent,
      ...
      <div className="relative container px-4 md:px-8">
        <div className="grid items-start gap-14 lg:grid-cols-12 lg:gap-12">
          ...
          <div className="lg:col-span-7">
            <figure className="relative mx-auto max-w-3xl lg:mr-0 lg:ml-auto">
              <div className="relative overflow-hidden rounded-lg border border-border bg-background mask-[linear-gradient(to_top_right,transparent_0%,transparent_14%,rgba(0,0,0,0.35)_32%,rgba(0,0,0,0.92)_46%,#000_58%)] mask-size-[100%_100%] mask-center mask-no-repeat [-webkit-mask-image:linear-gradient(to_top_right,transparent_0%,transparent_14%,rgba(0,0,0,0.35)_32%,rgba(0,0,0,0.92)_46%,#000_58%)] [-webkit-mask-repeat:no-repeat] [-webkit-mask-size:100%_100%]">
                <img
                  src={image.src}
                  alt={image.alt}
