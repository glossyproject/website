...
interface Feature364Props extends FeatureIconListProps {}
type Props = Partial<Feature364Props>;

const defaultProps: Feature364Props = {
  features: [
    {
