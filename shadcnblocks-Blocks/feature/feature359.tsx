...
interface Feature359Props extends FeatureIconListProps {}
type Props = Partial<Feature359Props>;

const defaultProps: Feature359Props = {
    ...
    <section className={cn("py-32", className)}>
      <div className="container">
        ...
        <div className="mx-auto grid max-w-5xl gap-6 md:grid-cols-2">
          {items.map((feature, i) => (
            <div key={i} className="flex gap-5 rounded-lg bg-accent p-6">
