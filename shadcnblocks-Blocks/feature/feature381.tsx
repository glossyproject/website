...
interface Feature381Props extends FeatureCardListProps {}
type Props = Partial<Feature381Props>;

const defaultProps: Feature381Props = {
    ...
    <section className={cn("py-32", className)}>
      <div className="container mx-auto">
        <Carousel
          ...
          className="w-full"
        >
          <div className="mb-9 flex items-end justify-between gap-4 lg:mb-14">
            <h2 className="min-w-0 flex-1 text-3xl font-semibold tracking-tight text-balance lg:text-4xl">
              {heading}
            </h2>
