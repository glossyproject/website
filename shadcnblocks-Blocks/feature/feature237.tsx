        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          {CARDS.map((card, index) => (
            <a key={index} href={card.href} className="group block h-full">
              <div className="bg-card hover:border-primary flex h-full flex-col rounded-xl border p-6 transition-all duration-200 hover:shadow-lg">
                <div className="flex h-full flex-col justify-between space-y-4">
                  <div>
                    <div className="flex items-start justify-between">
                      <div>
                        <h3 className="text-foreground group-hover:text-primary text-xl transition-colors duration-200">
                          {card.title}
                        </h3>
                      ...
                      <ArrowUpRight className="text-muted-foreground group-hover:text-primary h-5 w-5 transition-transform duration-200 group-hover:-translate-y-1 group-hover:translate-x-1" />
                    </div>
