...
interface Feature367Props extends FeatureIconListProps {}
type Props = Partial<Feature367Props>;

const defaultProps: Feature367Props = {
  features: [
    {
