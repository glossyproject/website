  ...
  return (
    <section className={cn("py-32", className)}>
      <div className="container mx-auto">
        <div className="flex flex-col items-start gap-16 md:flex-row-reverse md:items-center">
          ...
          <div className="relative isolate flex h-[min(32rem,85vw)] min-h-112 w-full overflow-hidden p-2 lg:h-128 lg:w-3/5">
            <div
              aria-hidden
            ...
            <div className="absolute inset-0 z-20 flex items-center justify-center p-2">
              <div className="aspect-4/3 max-h-full min-h-0 w-full overflow-hidden rounded-lg border border-border">
                <img
                  src={image.src}
                  alt={image.alt}
            ...
            <div className="absolute inset-0 z-5 bg-linear-to-l from-background/50 via-transparent to-background/50"></div>
          </div>
        </div>
      </div>
    </section>
