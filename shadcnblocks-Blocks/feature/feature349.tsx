...
interface Feature349Props extends FeatureIconListProps {}
type Props = Partial<Feature349Props>;

const defaultProps: Feature349Props = {
    ...
    <section className={cn("py-32", className)}>
      <div className="container">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {items.map((feature, i) => (
            <div key={i} className="flex flex-col rounded-lg border p-6">
              <div className="mb-4 flex size-10 items-center justify-center rounded-md bg-accent">
                {feature.icon}
              </div>
