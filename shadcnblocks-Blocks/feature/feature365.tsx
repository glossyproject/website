...
interface Feature365Props extends FeatureIconListProps {}
type Props = Partial<Feature365Props>;

const defaultProps: Feature365Props = {
  features: [
    {
