...
interface Feature366Props extends FeatureIconListProps {}
type Props = Partial<Feature366Props>;

const defaultProps: Feature366Props = {
  features: [
    {
