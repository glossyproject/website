...
interface Feature356Props extends FeatureIconListProps {}
type Props = Partial<Feature356Props>;

const defaultProps: Feature356Props = {
      ...
      <div className="container">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {items.map((feature, i) => (
            <div
              key={i}
              className="flex flex-col gap-4 rounded-lg bg-accent p-6"
            >
