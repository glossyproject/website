...
interface Feature353Props extends FeatureIconListProps {}
type Props = Partial<Feature353Props>;

const defaultProps: Feature353Props = {
      ...
      <div className="container">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {items.map((feature, i) => (
            <div
              key={i}
              className="flex flex-col gap-3 rounded-lg bg-accent p-6"
            >
