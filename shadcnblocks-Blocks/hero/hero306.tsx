...
interface Hero306Props extends HeroFeatureIconsProps {}
type Props = Partial<Hero306Props>;

const defaultProps: Hero306Props = {
  badge: "Platform",
...
/** Split-pane: copy and features on a muted panel, full-bleed image opposite; stacks when no imagery. */
  ...
  return (
    <section className={cn("overflow-hidden py-32", className)}>
      <div className="container mx-auto">
        {leadImage ? (
          <div className="mx-auto grid max-w-6xl overflow-hidden rounded-2xl border border-border lg:grid-cols-2">
            <div className="flex flex-col justify-center gap-10 border-border bg-muted/30 px-8 py-12 md:px-12 lg:border-r lg:py-16">
              ...
              <div className="border-t border-border pt-8">{featureGrid}</div>
            </div>
          ...
          <div className="mx-auto max-w-5xl space-y-12">
            ...
            <div className="rounded-xl border border-border bg-muted/20 p-8 md:p-10">
