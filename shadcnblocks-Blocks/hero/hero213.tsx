    ...
    <section className="py-32">
      <div className="container">
        ...
        <div className="relative mt-4">
          <div className="bg-muted relative z-10 mx-auto my-7 flex w-fit cursor-pointer items-center justify-center gap-8 rounded-full px-4 py-2 md:my-0 lg:translate-y-12 lg:py-3 xl:px-8 xl:py-4">
          ...
          <div className="bottom-22 rounded-4xl xl:h-42 2xl:w-62 absolute -left-8 hidden h-36 w-32 items-center justify-center overflow-hidden border lg:flex xl:bottom-28 2xl:-left-28 2xl:h-52 2xl:rounded-[4rem]">
            <AnimatePresence mode="popLayout">
              <motion.img
                key={currentIndex}
                initial={{ opacity: 0 }}
