...
interface Hero267Props extends HeroInsetImageProps {}
type Props = Partial<Hero267Props>;

const defaultProps: Hero267Props = {
      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 gap-x-20 gap-y-32 lg:grid-cols-2">
          <div className="min-w-0 pb-12 pr-12 md:pb-16 md:pr-16">
            {/* Full-bleed left: mirror of viewport breakout used for right-bleed columns */}
            <div
              className={cn(
