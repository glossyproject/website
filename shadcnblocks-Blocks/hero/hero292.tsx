...
interface Hero292Props extends HeroFeatureIconsProps {}
type Props = Partial<Hero292Props>;

const defaultProps: Hero292Props = {
  badge: "Platform",
...
/** Segmented grid supports six proof points under a single frame. */
const MAX_FEATURES = 6;

const sixFeatures: NonNullable<HeroFeatureIconsProps["features"]> = [
  {
    title: "Composable patterns",
    description: "Ship faster with structured sections and consistent spacing.",
    icon: Braces,
  },
  {
    title: "Design tokens",
  ...
  },
  {
    ...
    description:
      "SOC-aware defaults with encryption posture you can explain to buyers.",
    icon: ShieldCheck,
  },
  {
    title: "Composable layers",
    description:
      "Split presentation from data without rebuilding screens from scratch.",
    icon: Layers,
  },
  {
    title: "Measured performance",
    description:
      "Ship interactions that stay responsive as tables and dashboards grow.",
    icon: Gauge,
  },
];
          ...
          <div className="grid gap-px overflow-hidden rounded-xl border bg-border sm:grid-cols-2 lg:grid-cols-3">
            {visibleFeatures.map((feature) => {
              ...
              return (
                <div
                  key={feature.title}
                  className="flex flex-col gap-3 bg-background p-5 lg:p-6"
                >
