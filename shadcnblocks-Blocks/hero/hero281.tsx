...
interface Hero281Props extends HeroFeatureSliderProps {}
type Props = Partial<Hero281Props>;

const defaultProps: Hero281Props = {
...
/** Bottom carousel uses three slides in this layout. */
const MAX_IMAGES = 3;

const Hero281 = (props: Props) => {
  const {
    heading,
    buttonPrimary,
    buttonSecondary,
      ...
      <div className="container mx-auto">
        <div className="mb-16 space-y-12 text-center">
          <div className="mx-auto max-w-4xl">
            <h1 className="mx-auto max-w-3xl text-2xl font-semibold tracking-tight text-pretty sm:text-3xl md:text-4xl lg:text-6xl">
              {heading}
            </h1>
          </div>
