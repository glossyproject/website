...
interface Hero269Props extends HeroInsetImageProps {}
type Props = Partial<Hero269Props>;

const defaultProps: Hero269Props = {
...
/** Inset-image hero: copy left, image column right — contained in `container` (no viewport bleed). */

const Hero269 = (props: Props) => {
      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 gap-x-20 gap-y-32 lg:grid-cols-2">
          ...
          <div className="min-w-0 pb-12 pl-12 md:pb-16 md:pl-16">
            <div className="relative flex h-96 w-full flex-col overflow-visible rounded-lg bg-muted pt-4 pl-4 md:h-182.5 md:pt-12 md:pl-12">
              <div className="relative min-h-0 w-full flex-1 overflow-hidden rounded-tl-md border border-border">
                <img
                  src={image.src}
                  alt={image.alt}
