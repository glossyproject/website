...
interface Hero274Props extends HeroFeatureSliderProps {}
type Props = Partial<Hero274Props>;

const defaultProps: Hero274Props = {
  ...
  return (
    <section className={cn("py-32", className)}>
      <div className="container mx-auto overflow-hidden">
        ...
        <div
          className="mt-2 flex w-full flex-col md:flex-row"
        ...
        >
          {visibleFeatures.map((feature, index) => (
            <React.Fragment key={feature.title}>
              ...
              <div
                className="flex grow basis-0 cursor-default flex-col rounded-xl p-4 transition-colors hover:bg-muted/40"
                onMouseEnter={() => setActiveImageIndex(index)}
              >
                <div className="mb-6 flex size-10 items-center justify-center rounded-lg bg-background shadow-md">
