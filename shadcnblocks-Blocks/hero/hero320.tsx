...
interface Hero320Props extends HeroInsetImageProps {}
type Props = Partial<Hero320Props>;

const defaultProps: Hero320Props = {
  ...
  insetImage: {
  src: "https://deifkwefumgah.cloudfront.net/shadcnblocks/image-set/modern/saas-inset-detail/saas-inset-detail-3.png",
  alt: "CRM dashboard detail",
},
};

const Hero320 = (props: Props) => {
        ...
        <div className="grid grid-cols-1 gap-x-16 gap-y-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="min-w-0 pb-12 pl-12 md:pb-16 md:pl-16">
            <div className="relative overflow-visible">
              ...
              />
              {insetImage && (
                <div className="absolute -bottom-6 -left-6 z-20 w-40 -rotate-4 rounded-lg shadow-md md:-bottom-8 md:-left-8 md:w-56 md:rounded-xl lg:w-64">
