    ...
    <section className="py-32">
      <div className="container overflow-hidden">
        <div className="mx-auto flex max-w-2xl flex-col items-center justify-center gap-4">
          <p className="text-muted-foreground/40 z-10 px-10 text-center tracking-tight lg:text-lg">
            Lorem, ipsum dolor sit amet consectetur
          </p>
          <h1 className="font-playfair text-center text-5xl italic tracking-tighter lg:text-6xl">
            Explore the Authentic
          </h1>
        </div>

        <div className="relative mt-16 flex h-full flex-col items-center justify-center">
          <div className="h-112 pointer-events-none relative z-20 mx-auto flex w-80 justify-center overflow-hidden rounded-3xl">
          ...
          <motion.div
            ...
            className="h-192 rotate-65 absolute z-10 w-52 rounded-[100%] bg-yellow-500 blur-2xl"
          />
          <div className="relative z-10 mx-auto mb-12 mt-10 flex w-fit justify-center">
          ...
          <div
            className="h-125 absolute bottom-0 left-0 right-0"
            style={{ clipPath: "inset(0 0 -100% 0)" }}
          >
            <div className="z-2 to-background dark:to-background absolute top-0 h-36 w-full bg-gradient-to-t from-transparent to-70%" />
            <SkiperUiMarquee />
            <div className="z-2 to-background dark:to-background absolute bottom-0 h-36 w-full bg-gradient-to-b from-transparent to-70%" />
          </div>
        </div>
      </div>
    </section>
...
function Card() {
  ...
  return (
    <motion.div
      ...
      animate={controls}
      className={cn(
        "size-17 border-muted relative overflow-hidden rounded-3xl border p-4",
