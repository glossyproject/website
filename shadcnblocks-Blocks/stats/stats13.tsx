    ...
    <section className="py-32">
      ...
      <div className="gradient container">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="text-muted-foreground lg:px-15 my-4 tracking-tight lg:text-lg">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde
            perferendis deserunt quis excepturi reiciendis nulla?
          </p>
        </div>
        <div className="h-112 relative mx-auto mt-20 flex max-w-4xl items-center justify-center gap-2">
          {[
  ...
  return (
    <div className="group relative h-full w-full">
      <div className="candy-bg relative h-full w-full overflow-hidden rounded-[40px]">
        ...
        >
          <div className="h-15 bg-muted/20 relative flex w-full items-center justify-center gap-2 rounded-full tracking-tighter">
            <div className="h-13 w-13 bg-muted/20 absolute left-1 top-1 hidden items-center justify-center rounded-full md:flex">
