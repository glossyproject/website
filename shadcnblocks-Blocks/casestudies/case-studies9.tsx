...
interface CaseStudies9Props extends CaseStudiesCarouselProps {}
type Props = Partial<CaseStudies9Props>;

const defaultProps: CaseStudies9Props = {
  title: "Case studies",
  description:
...
const CaseStudies9 = (props: Props) => {
        ...
        >
          <CarouselContent className="-ml-5">
            {items.map((item) => (
              <CarouselItem
                key={item.id}
                className="basis-full pl-5 md:min-w-0 md:basis-1/2"
              >
