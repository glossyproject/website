  ...
  return (
    <section className="bg-background min-h-screen">
      ...
      <div className="grid w-full grid-cols-1 md:grid-cols-2">
        {/* Header Section */}
        <div className="bg-background relative h-[50vh] md:h-[60vh]">
          <div className="absolute inset-0 bottom-12 flex items-end">
            <div className="text-foreground px-6 text-left sm:px-8 md:px-12 lg:px-16 xl:px-20">
              <h1 className="max-w-1/2 mb-4 text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl lg:mb-8 lg:text-8xl">
